...
export class AutenticacionCertificadosService {
...
validarCertificado(hash : string): Observable<any>{
  return this.http.post(`${this.url}validarCertificado.php`, JSON.stringify(hash))
}
