...
import { DocAcademicoRoutingModule } from './doc-academico-routing.module';
...
import { CustomMatPaginatorIntl } from './carga-calificaciones/custom-mat-paginator-intl'; // Asegúrate de ajustar la ruta de importación
...
@NgModule({
  ...
  providers: [DatePipe,
    {provide: MAT_DATE_LOCALE, useValue: 'es-VE'}, {provide: ControlEstudiosService},  { provide: MatPaginatorIntl, useClass: CustomMatPaginatorIntl }
  ],
})
export class DocAcademicoModule { }
