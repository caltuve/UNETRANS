...
getDocente(identificacion: any): Observable<any>{
  return this.http.post(`${this.url}verify_docente.php`, JSON.stringify(identificacion))
}
...
createPersonDocente(datospersona : any): Observable<any>{
  return this.http.post(`${this.url}creardocente.php`, JSON.stringify(datospersona))
}
}
